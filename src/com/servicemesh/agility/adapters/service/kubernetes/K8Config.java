...
public class K8Config
{
    ...
    {
        return getPropertyAsInteger(K8Config.REQUEST_RETRIES, settings, K8Config.REQUEST_RETRIES_DEFAULT);
    }
    ...
    {
        return getPropertyAsInteger(K8Config.CONNECTION_TIMEOUT, settings, K8Config.CONNECTION_TIMEOUT_DEFAULT_SECS * 1000);
    }
    ...
    {
        return getPropertyAsInteger(K8Config.SOCKET_TIMEOUT, settings, K8Config.SOCKET_TIMEOUT_DEFAULT_SECS * 1000);
    }
