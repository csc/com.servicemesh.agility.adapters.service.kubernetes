...
public class K8Util
{
    ...
    private static final Logger logger = Logger.getLogger(K8Util.class);
                ...
                if ((methodName.startsWith("get") || methodName.startsWith("is")) && !hasParams)
                {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            {
                                buf.append(label);
                                buf.append(K8Util.maskPrivateKey((String) o));
                            }
                            else
                            {
                                buf.append(label);
    ...
    public static Link makeLinkStub(Integer id, String name)
    {
        ...
        retval.setName((K8Util.isValued(name) ? name : null));
    ...
    public static String arrayToString(String[] array, String separator)
    {
        ...
        {
            String sepString = (K8Util.isValued(separator) ? separator : ",");
            String sep = "";
